---
title: "BA(binding affinity) model"
...
This part focuses on BA model construction, it contains the following sections:

- [Training data](#training-data) - Data download and process
- [BA model](#ba-model) - constructed BA model by LSTM
...
The training data come form NetMHCIIpan 4.0，you can find the data in [IEDB](http://tools.iedb.org/mhcii/download/), the details are described as below:
...
### run BA,netMHCIIpan,mixMHC2pred get result
